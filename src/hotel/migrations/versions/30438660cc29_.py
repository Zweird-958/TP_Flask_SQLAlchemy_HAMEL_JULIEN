...
Revision ID: 30438660cc29
Revises: 
Create Date: 2024-02-16 12:53:30.048544
...
def upgrade():
    ...
    sa.Column('status', sa.Enum('en_attente', 'confirmee', 'annulee', name='status'), nullable=False),
